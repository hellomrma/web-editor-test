    ...
    <>
      ...
      <div className="home-container">
        <header className="home-header">
          <div className="home-badge" aria-label="플랫폼 이름">Rich Editor Playground</div>
          <h1>웹 에디터 테스트 플랫폼</h1>
        ...
        <section className="editor-cards" aria-label="에디터 선택">
          <article>
            <Link to="/tiptap" className="editor-card editor-card-tiptap" aria-label="TipTap 에디터로 이동">
              <div className="card-icon-wrapper" aria-hidden="true">
                <div className="card-icon">✏️</div>
              </div>
              <div className="card-badge card-badge-free" aria-label="무료 버전">Free</div>
              <h2>TipTap</h2>
          ...
          <article>
            <Link to="/ckeditor-basic" className="editor-card editor-card-basic" aria-label="CKEditor Basic 에디터로 이동">
              <div className="card-icon-wrapper" aria-hidden="true">
                <div className="card-icon">📝</div>
              </div>
              <div className="card-badge card-badge-free" aria-label="무료 GPL 버전">Free (GPL)</div>
          ...
          <article>
            <Link to="/ckeditor-rich" className="editor-card editor-card-rich" aria-label="CKEditor Rich 에디터로 이동">
              <div className="card-icon-wrapper" aria-hidden="true">
                <div className="card-icon">✨</div>
              </div>
              <div className="card-badge card-badge-premium" aria-label="프리미엄 버전">Premium</div>
              <h2>CKEditor Rich</h2>
